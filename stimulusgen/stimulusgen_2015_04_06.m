...
load(fullfile(soc_stimpath, 'stimuli.mat'), 'bpfilter');

imFile = fullfile(soc_stimpath, 'stimuli.mat');
gratingNums = [176:180];
patternNums = [181, 182, 183, 85, 184];
existingIms = loadKnkImages(imFile, [gratingNums, patternNums]);
...
save(fullfile(soc_stimpath, 'stimuli-2015-04-06_rerun'), 'stimuli');
