...
save(fullfile(soc_stimpath, 'stimuli-2016-02-17-new_rerun.mat'), 'stimuli', '-v7.3');
...
stimuli.cpd = cpd;
stimuli.patvals = patvals;
save(fullfile(soc_stimpath, 'stimuli-2016-02-17-patterns-new_rerun.mat'), 'stimuli', '-v7.3');
...
stimuli.cpd = cpd;
save(fullfile(soc_stimpath, 'stimuli-2016-02-17-noise-new_rerun.mat'), 'stimuli', '-v7.3');

%% FIX THE THING
load(fullfile(soc_stimpath, 'stimuli-2016-02-17-noise_rerun.mat'));
...
save(fullfile(soc_stimpath, 'stimuli-2016-02-17-noise_rerun.mat'), 'stimuli', '-v7.3');

load(fullfile(soc_stimpath, 'stimuli-2016-02-17-patterns_rerun.mat'));
...
save(fullfile(soc_stimpath, 'stimuli-2016-02-17-patterns_rerun.mat'), 'stimuli', '-v7.3');

load(fullfile(soc_stimpath, 'stimuli-2016-02-17_rerun.mat'));
stimuli.all = permute(stimuli.imStack, [1 2 4 3]);
stimuli.all = reshape(stimuli.all, size(stimuli.all,1), size(stimuli.all,2), []);
save(fullfile(soc_stimpath, 'stimuli-2016-02-17_rerun.mat'), 'stimuli', '-v7.3');