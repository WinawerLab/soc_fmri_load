...
save(fullfile(soc_stimpath, 'stimuli-2015-10-05_rerun.mat'), 'stimuli', '-v7.3');

%% Retroactive fixing of imStack bug
imFile = 'stimuli-2015-10-05_rerun.mat';
load(fullfile(soc_stimpath, imFile), 'stimuli');
...
save(fullfile(soc_stimpath, imFile), 'stimuli');
